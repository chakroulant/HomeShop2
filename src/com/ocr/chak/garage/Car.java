...
public class Car extends Vehicle {
    ...
    public Car(String modelName, String description, String manufacter, int year, String color, int speed, int[] dimensions, int weight, int door, int literPer100km,
               String motor, List<String> options) {
        super(modelName, description, manufacter, year, color,speed, dimensions, weight);
        this.door = door;
